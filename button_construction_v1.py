...
size_z: {zPMT}, // changed to put tarp behind washer plates
position: [0.0, 0.0, 0.0],
...
#midsurface
        ...
        for g in range(positions):
            ...
            _geoFile += "{\n"
            _geoFile += "name: \"GEO\",\n"
            _geoFile +=  f"index: \"midsurface_frontEncapsulation{counter}_{g}\",\n"       
            _geoFile += "valid_begin: [0, 0],\n"
            _geoFile += "valid_end: [0, 0],\n"           
            _geoFile +=  f"mother: \"frontEncapsulation{counter}_{g}\",\n"
            _geoFile +=  "type: \"border\",\n"  
            #_geoFile +=  f"volume1: \"frameModule{counter}\",\n"        
            _geoFile +=  "volume1: \"detector_target_gb\",\n"
            _geoFile +=  f"volume2: \"frontEncapsulation{counter}_{g}\",\n"     
            _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
            _geoFile +=  "surface: \"reflective_tarp\",\n"    
            _geoFile +=  "drawstyle: \"solid\",\n"
            _geoFile += "}\n"
            ...
            _geoFile += "{\n"
            _geoFile += "name: \"GEO\",\n"
            _geoFile +=  f"index: \"midsurface_rearEncapsulation{counter}_{g}\",\n"       
            _geoFile += "valid_begin: [0, 0],\n"
            _geoFile += "valid_end: [0, 0],\n"           
            _geoFile +=  f"mother: \"rearEncapsulation{counter}_{g}\",\n"
            _geoFile +=  "type: \"border\",\n"  
            #_geoFile +=  f"volume1: \"frameModule{counter}\",\n"        
            _geoFile +=  "volume1: \"detector_target_gb\",\n"
            _geoFile +=  f"volume2: \"rearEncapsulation{counter}_{g}\",\n"     
            _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
            _geoFile +=  "surface: \"reflective_tarp\",\n"    
            _geoFile +=  "drawstyle: \"solid\",\n"
            _geoFile += "}\n"
...
#############################################
            ...
            _geoFile += "{\n"
            _geoFile += "name: \"GEO\",\n"
            _geoFile +=  f"index: \"midsurface_metalFflange{counter}_{g}\",\n"       
            _geoFile += "valid_begin: [0, 0],\n"
            _geoFile += "valid_end: [0, 0],\n"           
            _geoFile +=  f"mother: \"metalFflange{counter}_{g}\",\n"
            _geoFile +=  "type: \"border\",\n"  
            _geoFile +=  f"volume1: \"frameModule{counter}\",\n"
            _geoFile +=  f"volume2: \"metalFflange{counter}_{g}\",\n"     
            _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
            _geoFile +=  "surface: \"reflective_tarp\",\n"  
            _geoFile +=  "drawstyle: \"solid\",\n"  
            _geoFile += "}\n"
            ...
            _geoFile += "{\n"
            _geoFile += "name: \"GEO\",\n"
            _geoFile +=  f"index: \"midsurface_metalRflange{counter}_{g}\",\n"       
            _geoFile += "valid_begin: [0, 0],\n"
            _geoFile += "valid_end: [0, 0],\n"           
            _geoFile +=  f"mother: \"metalRflange{counter}_{g}\",\n"
            _geoFile +=  "type: \"border\",\n"  
            _geoFile +=  f"volume1: \"frameModule{counter}\",\n"
            _geoFile +=  f"volume2: \"metalRflange{counter}_{g}\",\n"     
            _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
            _geoFile +=  "surface: \"reflective_tarp\",\n"  
            _geoFile +=  "drawstyle: \"solid\",\n"  
            _geoFile += "}\n"
            ...
            _geoFile += "{\n"
            _geoFile += "name: \"GEO\",\n"
            _geoFile +=  f"index: \"midsurface_acrylicflange{counter}_{g}\",\n"       
            _geoFile += "valid_begin: [0, 0],\n"
            _geoFile += "valid_end: [0, 0],\n"           
            _geoFile +=  f"mother: \"acrylicflange{counter}_{g}\",\n"
            _geoFile +=  "type: \"border\",\n"  
            _geoFile +=  f"volume1: \"frameModule{counter}\",\n"
            _geoFile +=  f"volume2: \"acrylicflange{counter}_{g}\",\n"     
            _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
            _geoFile +=  "surface: \"reflective_tarp\",\n"  
            _geoFile +=  "drawstyle: \"solid\",\n"  
            _geoFile += "}\n"
...
#        _geoFile +=  f"rotation: [0., 0., 0.],\n"        
        ...
        _geoFile +=  "type: \"border\",\n"  
        _geoFile +=  f"volume1: \"detector_target_gb\",\n"
...
# #now including midsurfaces for these
        ...
        _geoFile += "{\n"
        _geoFile += "name: \"GEO\",\n"
        _geoFile +=  f"index: \"midsurface_topCross{counter}\",\n"       
        _geoFile += "valid_begin: [0, 0],\n"
        _geoFile += "valid_end: [0, 0],\n"           
        _geoFile +=  f"mother: \"centerSquSide{counter}\",\n"
        _geoFile +=  "type: \"border\",\n"  
        _geoFile +=  f"volume1: \"detector_target_gb\",\n"
        _geoFile +=  f"volume2: \"topCross{counter}\",\n"     
        _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
        _geoFile +=  "surface: \"reflective_tarp\",\n"  
        _geoFile +=  "drawstyle: \"solid\",\n"  
        _geoFile += "}\n"
        ...
        _geoFile += "{\n"
        _geoFile += "name: \"GEO\",\n"
        _geoFile +=  f"index: \"midsurface_bottomCrossL{counter}\",\n"       
        _geoFile += "valid_begin: [0, 0],\n"
        _geoFile += "valid_end: [0, 0],\n"           
        _geoFile +=  f"mother: \"centerSquSide{counter}\",\n"
        _geoFile +=  "type: \"border\",\n"  
        _geoFile +=  f"volume1: \"bottomCross{counter}\",\n"
        _geoFile +=  f"volume2: \"bottomCrossL{counter}\",\n"     
        _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
        _geoFile +=  "surface: \"reflective_tarp\",\n"  
        _geoFile +=  "drawstyle: \"solid\",\n"  
        _geoFile += "}\n"
        ...
        _geoFile += "{\n"
        _geoFile += "name: \"GEO\",\n"
        _geoFile +=  f"index: \"midsurface_bottomCrossR{counter}\",\n"       
        _geoFile += "valid_begin: [0, 0],\n"
        _geoFile += "valid_end: [0, 0],\n"           
        _geoFile +=  f"mother: \"centerSquSide{counter}\",\n"
        _geoFile +=  "type: \"border\",\n"  
        _geoFile +=  f"volume1: \"bottomCross{counter}\",\n"
        _geoFile +=  f"volume2: \"bottomCrossR{counter}\",\n"     
        _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
        _geoFile +=  "surface: \"reflective_tarp\",\n"  
        _geoFile +=  "drawstyle: \"solid\",\n"  
        _geoFile += "}\n"
...
#HERE
    ...
    _geoFile += "{\n"
    _geoFile += "name: \"GEO\",\n"
    _geoFile +=  f"index: \"midsurface_metalRflangeTB{i}\",\n"       
    _geoFile += "valid_begin: [0, 0],\n"
    _geoFile += "valid_end: [0, 0],\n"           
    _geoFile +=  f"mother: \"metalRflangeTB{i}\",\n"
    _geoFile +=  "type: \"border\",\n"  
    _geoFile +=  f"volume1: \"detector_target_gb\",\n"
    _geoFile +=  f"volume2: \"metalRflangeTB{i}\",\n"     
    _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
    _geoFile +=  "surface: \"reflective_tarp\",\n"  
    _geoFile +=  "drawstyle: \"solid\",\n"  
    _geoFile += "}\n"
    ...
    _geoFile += "{\n"
    _geoFile += "name: \"GEO\",\n"
    _geoFile +=  f"index: \"midsurface_metalFflangeTB{i}\",\n"       
    _geoFile += "valid_begin: [0, 0],\n"
    _geoFile += "valid_end: [0, 0],\n"           
    _geoFile +=  f"mother: \"metalFflangeTB{i}\",\n"
    _geoFile +=  "type: \"border\",\n"  
    _geoFile +=  f"volume1: \"detector_target_gb\",\n"
    _geoFile +=  f"volume2: \"metalFflangeTB{i}\",\n"     
    _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
    _geoFile +=  "surface: \"reflective_tarp\",\n"  
    _geoFile +=  "drawstyle: \"solid\",\n"  
    _geoFile += "}\n"
    ...
    _geoFile += "{\n"
    _geoFile += "name: \"GEO\",\n"
    _geoFile +=  f"index: \"midsurface_acrylicTB{i}\",\n"       
    _geoFile += "valid_begin: [0, 0],\n"
    _geoFile += "valid_end: [0, 0],\n"           
    _geoFile +=  f"mother: \"acrylicflangeTB{i}\",\n"
    _geoFile +=  "type: \"border\",\n"  
    _geoFile +=  f"volume1: \"detector_target_gb\",\n"
    _geoFile +=  f"volume2: \"acrylicflangeTB{i}\",\n"     
    _geoFile +=  "reverse: 1, //0 only considers photons from a->b, 1 does both directions\n"     
    _geoFile +=  "surface: \"reflective_tarp\",\n"  
    _geoFile +=  "drawstyle: \"solid\",\n"  
    _geoFile += "}\n"
